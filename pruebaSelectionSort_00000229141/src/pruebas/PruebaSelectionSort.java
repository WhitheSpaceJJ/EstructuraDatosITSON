...
/**
 ** Esta clase de prueba prueba los algoritmos de ordenamiento de seleccion
 * (selectionSort) del módulo Ordenamiento.java Alumno; José Jesús Orozco
 * Hernández ID; 00000229141
 *
 * @author Jose Jesus
 */
public class PruebaSelectionSort {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ordenamiento por el Metodo de seleccion");
        System.out.println("");
        ...
        Ordenamiento.selectionSort(datos1);
        ...
        Ordenamiento.selectionSort(datos2);
        ...
        Ordenamiento.selectionSort(alumnos1, new AlumnoPorIdCompara());
        ...
        Ordenamiento.selectionSort(alumnos2, new AlumnoPorNombreCompara());
