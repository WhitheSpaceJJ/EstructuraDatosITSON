 ...
 * represente un grafo No dirigido Alumno; José Jesús Orozco Hernández ID;
 * 00000229141
 *
 ...
 */
public interface INoDiGraph<T, K, V> extends IGraph<T, K, V> {
    ...
    /**
     * Obtiene la lista de todos los vertices verticeI tal que hay una arista
     * entre los vertices vertice y verticeI
     *
     * @param vertice Vertice del que se quiere obtener la lista
     * @return La lista de todos los vertices vecinos de verticeX
     * @throws GraphException Si el vertice verticeX no existe
     */
