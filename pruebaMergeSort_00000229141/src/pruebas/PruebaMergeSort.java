...
/**
 ** Esta clase de prueba prueba los algoritmos de ordenamiento de merge
 * (MergeSort) del módulo Ordenamiento.java Alumno; José Jesús Orozco
...
public class PruebaMergeSort {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ordenamiento por el Metodo de union(MergeShort)");
        System.out.println("");
        ...
        Ordenamiento.mergeSort(alumnos1, new AlumnoPorIdCompara());
        ...
        Ordenamiento.mergeSort(alumnos2, new AlumnoPorNombreCompara());
